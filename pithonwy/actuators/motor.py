...
class Motor:
    ...
    def __init__(self, gpio_pwm_pin=4, esc_max_pulse_length=2000, esc_min_pulse_length=700):
        ...
        self.pi.set_servo_pulsewidth(gpio_pwm_pin, 0)
        # Warning!
    ...
    def arm(self):
        ...
        self.pi.set_servo_pulsewidth(self.gpio_pwm_pin,self.min_value)
    ...
    def calibrate_esc(self):
        ...
        inp = input()
        if inp == '':
            self.pi.set_servo_pulsewidth(self.gpio_pwm_pin, self.max_value)
